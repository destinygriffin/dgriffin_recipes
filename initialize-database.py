...
mongo = "mongodb+srv://recipe_user:ltuOfENE1sl1KpFK@cluster0.qyy17.mongodb.net/recipe_db?retryWrites=true&w=majority"
...
def initial_database():
    ...
    # add users
    mike = add_user('Destiny', 'Griffin', 'destiny@destiny.com', 'abc123', 'admin')
